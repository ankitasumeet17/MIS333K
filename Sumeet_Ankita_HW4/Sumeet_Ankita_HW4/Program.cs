...
String connectionString = "Server=tcp:fa22sumeetankitahw4.database.windows.net,1433;Initial Catalog=fa22sumeetankitahw4;Persist Security Info=False;User ID=MISAdmin;Password=1xsphw@x1;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";

builder.Services.AddDbContext<AppDbContext>(options => options.UseSqlServer(connectionString));

//NOTE: You need this line for including Identity in your project
IdentityBuilder identityBuilder = builder.Services.AddIdentityCore<AppUser>().AddRoles<IdentityRole>().AddEntityFrameworkStores<AppDbContext>();
